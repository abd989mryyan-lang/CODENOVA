...
public class contllu_phone_adapter extends RecyclerView.Adapter<contllu_phone_adapter.viewholder>{
  ArrayList<String>st;
   ArrayList<String>st2;
  public contllu_phone_adapter(ArrayList<String>st22,ArrayList<String>st33)
  {
      st=st22;
      st2=st33;
